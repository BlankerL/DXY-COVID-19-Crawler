...
2. **于2020年1月30日17:15开始统计API使用总人次，绝不统计单个IP的使用频率。**  
3. 为保证跨域请求能够正常进行，于2020年1月29日**切换至HTTPS协议**，若无法正常访问，请确认是否已经切换至HTTPS！
4. 2020年2月11日晚，世界卫生组织将病毒命名为COVID-19，为保证API使用的连贯性，仍然保持为`nCoV`。
